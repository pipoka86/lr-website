...
function PlanModal({ plan, onClose }) {
  ...
  if (!plan) return null
  return (
    <div onClick={() => { onClose(); }} style={{ position:'fixed', inset:0, background:'transparent', zIndex:99999, display:'flex', alignItems:'center', justifyContent:'center', padding:'24px' }}>
