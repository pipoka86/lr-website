...
function PlanModal({ plan, onClose }) {
  ...
  if (!plan) return null
  return (
    <div onClick={() => { document.body.style.overflow = ''; onClose(); }} style={{ position:'fixed', inset:0, background:'rgba(5,5,7,0.97)', zIndex:99999, display:'flex', alignItems:'center', justifyContent:'center', padding:'24px' }}>
