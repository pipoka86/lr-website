...
const schemaOrg = {
  ...
  "url": "https://lrsocialmedia.com.ar",
  "logo": "https://lrsocialmedia.com.ar/favicon-32.png",
  "description": "Agencia de marketing digital en Buenos Aires, Argentina. Gestión de redes sociales, creación de contenido y publicidad digital.",
  "address": {
    "@type": "PostalAddress",
  ...
  "contactPoint": {
    "@type": "ContactPoint",
    "telephone": "+54-9-11-5846-0123",
    "contactType": "customer service",
    "availableLanguage": "Spanish"
  },
  "sameAs": [
    "https://www.instagram.com/lr.socialcontent/"
  ],
  "areaServed": "Argentina",
  "serviceType": ["Social Media Management", "Content Creation", "Digital Advertising", "Web Design"]
}
  ...
  return (
    <html lang="es">
      ...
      <body className={inter.className} style={{ background: '#050507', color: '#fff', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        <MobileProvider><SmoothScroll /><GoogleAnalytics /><MetaPixel /><ScrollObserver />{children}</MobileProvider>
      <a href="https://wa.me/5491158460123?text=Hola%21%20Me%20interesa%20conocer%20m%C3%A1s%20sobre%20sus%20servicios%20de%20marketing%20digital.%20%C2%BFPodemos%20hablar%3F" target="_blank" rel="noopener noreferrer" className="wa-float" aria-label="WhatsApp">
