...
export const metadata = {
  title: 'Marketing Digital para Moda e Indumentaria | LR Social Media',
  description: 'Agencia de marketing digital para marcas de moda y tiendas de ropa en Argentina. Más ventas con contenido visual premium y publicidad en Instagram.',
  keywords: 'marketing digital moda Buenos Aires, redes sociales indumentaria Argentina, Instagram marcas de ropa, publicidad Meta Ads moda',
  openGraph: {
    title: 'Marketing Digital para Moda e Indumentaria | LR Social Media',
    description: 'Agencia de marketing digital para marcas de moda y tiendas de ropa en Argentina. Más ventas con contenido visual premium y publicidad en Instagram.',
    url: 'https://lrsocialmedia.com.ar/moda',
  ...
  return (
    <main style={{ background:'#050507', minHeight:'100vh', fontFamily:'Inter, -apple-system, sans-serif', color:'#fff' }}>
      ...
      <nav style={{ padding:'20px 40px', display:'flex', alignItems:'center', justifyContent:'space-between', borderBottom:'1px solid rgba(255,255,255,0.06)' }}>
        ...
        <a href="https://wa.me/5491158460123?text=Hola%21%20Me%20interesa%20el%20marketing%20digital%20para%20mi%20marca%20de%20moda.%20%C2%BFPodemos%20hablar%3F" target="_blank" rel="noopener noreferrer"
      ...
      <section style={{ padding:'80px 24px', textAlign:'center', maxWidth:'800px', margin:'0 auto' }}>
        ...
        <h1 style={{ fontSize:'clamp(32px,5vw,60px)', fontWeight:900, lineHeight:1.1, marginBottom:'20px' }}>
          Hacemos crecer tu marca de moda en Instagram
        </h1>
        <p style={{ fontSize:'18px', color:'rgba(255,255,255,0.5)', lineHeight:1.7, marginBottom:'40px' }}>
          Contenido visual, gestión de redes y publicidad para marcas de ropa en Argentina.
        </p>
        <a href="https://wa.me/5491158460123?text=Hola%21%20Me%20interesa%20el%20marketing%20digital%20para%20mi%20marca%20de%20moda.%20%C2%BFPodemos%20hablar%3F" target="_blank" rel="noopener noreferrer"
      ...
      <section style={{ padding:'60px 24px', background:'#0d0d12' }}>
        <div style={{ maxWidth:'700px', margin:'0 auto', textAlign:'center' }}>
          <h2 style={{ fontSize:'clamp(24px,3vw,36px)', fontWeight:800, marginBottom:'16px' }}>
            ¿Tu marca tiene buen producto pero no llega a suficiente gente en Instagram?
          </h2>
          <p style={{ fontSize:'17px', color:'rgba(255,255,255,0.5)', lineHeight:1.7 }}>
            Creamos contenido visual de alto impacto y campañas de venta para marcas de moda y tiendas de indumentaria.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth:'1000px', margin:'0 auto' }}>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(220px, 1fr))', gap:'20px' }}>
            <div style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:'16px', padding:'28px', display:'flex', flexDirection:'column', gap:'12px' }}>
              ...
              <h3 style={{ color:'#fff', fontWeight:700, fontSize:'18px' }}>Contenido visual premium</h3>
              <p style={{ color:'rgba(255,255,255,0.5)', fontSize:'15px', lineHeight:1.6 }}>Fotos y reels de producto que generan deseo y ventas.</p>
            </div>
            <div style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:'16px', padding:'28px', display:'flex', flexDirection:'column', gap:'12px' }}>
              <span style={{ fontSize:'32px' }}>🛍️</span>
              <h3 style={{ color:'#fff', fontWeight:700, fontSize:'18px' }}>Campañas de venta</h3>
              <p style={{ color:'rgba(255,255,255,0.5)', fontSize:'15px', lineHeight:1.6 }}>Publicidad en Instagram dirigida a tu público con alta intención de compra.</p>
            </div>
            <div style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:'16px', padding:'28px', display:'flex', flexDirection:'column', gap:'12px' }}>
              <span style={{ fontSize:'32px' }}>✨</span>
              <h3 style={{ color:'#fff', fontWeight:700, fontSize:'18px' }}>Estrategia de marca</h3>
              <p style={{ color:'rgba(255,255,255,0.5)', fontSize:'15px', lineHeight:1.6 }}>Identidad visual coherente y atractiva en todas tus redes.</p>
            </div>
            <div style={{ background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:'16px', padding:'28px', display:'flex', flexDirection:'column', gap:'12px' }}>
              <span style={{ fontSize:'32px' }}>📈</span>
              <h3 style={{ color:'#fff', fontWeight:700, fontSize:'18px' }}>Crecimiento orgánico</h3>
              <p style={{ color:'rgba(255,255,255,0.5)', fontSize:'15px', lineHeight:1.6 }}>Hashtags, colaboraciones y contenido para crecer sin pagar.</p>
            </div>
          </div>
        </div>
      </section>
